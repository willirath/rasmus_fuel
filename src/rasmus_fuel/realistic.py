...
def speed_og_from_power(
    ...
    **kwargs,
    ...
    # Find speed over ground using equation for power of engine given fixed constant engine power 
    ...
    def func(x):
        ...
        coeff1 =  coeff_water_drag * (u_current ** 2  + v_current ** 2) + coeff_wave_drag * w_wave_hight ** 2  
        coeff0 = - engine_power
