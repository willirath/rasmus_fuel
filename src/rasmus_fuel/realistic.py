...
def speed_og_from_power(
    ...
    **kwargs,
    ...
    """Calculate engine power from ship over ground
 ...
 def speed_og_from_power(
    ...
    speed_ship_init_og: npt.ArrayLike = None,
    u_current: npt.ArrayLike = None,
    v_current: npt.ArrayLike = None,
    u_wind: npt.ArrayLike = None,
    v_wind: npt.ArrayLike = None,
    ...
    **kwargs,
    ...
    # TODO : design a root solver using ArrayLike structures or use formula approximation to a simple expression of speed_og from the power 
    ...
    speed_og = fsolve(func, [speed_ship_init_og]).max()
